...
export default function EnterpriseIntegration() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden border-y border-primary/15 bg-[#0d0b10] py-16 text-stone-50 sm:py-20 lg:py-24"
    >
      <div className="absolute inset-0 opacity-55">
        ...
        <div className="absolute left-[-10%] top-[8%] h-[18rem] w-[18rem] rounded-full bg-[radial-gradient(circle,rgba(255,111,61,0.14),transparent_64%)]" />
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6">
        ...
        >
          <motion.div variants={itemVariants} className="max-w-3xl space-y-3">
            ...
            <h2 className="max-w-4xl text-3xl font-black uppercase leading-[0.95] tracking-[-0.05em] text-stone-50 sm:text-5xl lg:text-6xl">
          ...
          <div className="grid gap-4 xl:grid-cols-[minmax(0,1.04fr)_minmax(19rem,0.96fr)] xl:items-start">
            <motion.div
              variants={itemVariants}
              className="relative overflow-hidden rounded-[1.6rem] border border-primary/20 bg-[linear-gradient(135deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-4 shadow-[0_0_0_1px_rgba(255,255,255,0.02)] sm:p-6 lg:p-7"
            >
              ...
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                {items.map((item, index) => {
                  ...
                  return (
                    <div
                      key={item}
                      className="group rounded-[1.2rem] border border-white/10 bg-white/5 p-3.5 transition-colors hover:border-primary/40 hover:bg-primary/[0.08]"
                    >
                      <div className="mb-4 inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-primary/12 text-primary">
                        <Icon size={16} />
                      </div>
                      <p className="max-w-[14ch] text-sm font-semibold leading-tight text-stone-100 sm:text-base">
                        {item}
                      </p>
                    </div>
                  );
            ...
            <motion.aside
              variants={itemVariants}
              className="relative overflow-hidden rounded-[1.6rem] border border-primary/20 bg-[linear-gradient(180deg,rgba(255,112,67,0.1),rgba(255,255,255,0.02))] p-4 sm:p-6"
            >
